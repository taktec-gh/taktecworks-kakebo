...
### 実機確認の結果（2026-09-19、Windows・Chrome）

1〜8 すべて OK。8 は、ヘッダ無しで 401、`.env` の `CRON_SECRET` を付けて 200（件数の JSON）。
...
> **2026-09-19 に [design-decisions.md](../design-decisions.md)「8. デモアカウントで決めたこと」へ移した。** 以下は指示書を書いた時点の一覧。
